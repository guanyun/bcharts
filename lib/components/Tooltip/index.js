...
export default function Tooltip(props) {
    var children = props.children, _a = props.triggerOn, triggerOn = _a === void 0 ? 'hover' : _a, onShow = props.onShow, onChange = props.onChange, onHide = props.onHide, lock = props.lock, linkage = props.linkage, _b = props.showMarkers, showMarkers = _b === void 0 ? false : _b, options = __rest(props, ["children", "triggerOn", "onShow", "onChange", "onHide", "lock", "linkage", "showMarkers"]);
    var chartView = useChartView();
    ...
    return isReactTooltip(props) ? React.createElement(ReactTooltip, __assign({}, options, { showMarkers: showMarkers }), children) : React.createElement(TooltipNormal, __assign({}, props));
}
