...
var Connector = /** @class */ (function () {
    ...
    Connector.prototype.destroy = function () {
        unregisterAction("connect-".concat(this.type, "-").concat(this.id));
    };
    return Connector;
}());
export { Connector };
...
var createTooltipConnector = function () {
    ...
    registerAction("connect-tooltip-".concat(cm.id), /** @class */ (function (_super) {
    ...
    registerInteraction("connect-tooltip-".concat(cm.id), {
